...
<div class="place">
    ...
    <ul class="placeul">
        <li><a href="#">首页</a></li>
        <li><a href="http://120.78.138.95:8080/lcvc_ebuy/admin/producttype/producttypemanage">产品类别管理</a></li>
...
<div class="formbody">
    ...
    <form action="<%=basePath%>backstage/producttype/doUpdateProductType" METHOD="POST">
        ...
        <ul class="forminfo">
            <li><label>*产品分类名称</label><input name="name" type="text" class="dfinput" value="海鲜"/><i></i></li>
            <li><label>*图片</label>
            ...
            <li><label>外部链接地址</label><input name="linkUrl" type="text" class="dfinput" value="http://www.baidu.com"/><i></i></li>
            <li><label>产品描述</label>
